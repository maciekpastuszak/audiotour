  ...
  return (
    ...
    whileInView="show">
        <div className='flex ms-5 my-3'>
            <Image src="/img/app-icons/Icon_Audioprzewodniki.svg" width={55} height={55}alt="Ikona - Audioprzewodniki" />
        ...
        <div className={`relative w-full md:w-4/5 bg-[url('/img/app-banners/Banner_Audioprzewodniki_Wide.png')] bg-cover h-80`}>
