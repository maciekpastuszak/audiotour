...
const Kontakt = () => {
  return (
    ...
    <div className='flex flex-col md:flex-row my-10 md:mx-3 gap-5 items-center md:items-stretch'>
      ...
      <div className='flex flex-col w-5/6 md:w-1/3 items-center md:items-start border-2 border-gray-300 dark:border-gray-700 p-4 rounded-md shadow-md min-h-full bg-zinc-300'>
